...
class Ui_WaveformDialog(object):
    def setupUi(self, WaveformDialog):
        ...
        self.gridLayout_2.addWidget(self.saveDirectoryBrowseToolButton, 0, 2, 1, 1)
    ...
    def retranslateUi(self, WaveformDialog):
        ...
        self.saveDirectoryBrowseToolButton.setText(_translate("WaveformDialog", "Browse", None))
