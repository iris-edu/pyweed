...
class Ui_WaveformDialog(object):
    def setupUi(self, WaveformDialog):
        ...
        self.gridLayout_2.addWidget(self.saveDirectoryPushButton, 0, 1, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.saveFormatComboBox, 1, 1, 1, 1)
    ...
    def retranslateUi(self, WaveformDialog):
        ...
        self.label_2.setText(_translate("WaveformDialog", "secs after P-wave", None))
        self.secondsBeforeLabel.setText(_translate("WaveformDialog", "Waveform start", None))
        self.label.setText(_translate("WaveformDialog", "secs before P-wave", None))
        self.secondsAfterLabel.setText(_translate("WaveformDialog", "Waveform end", None))
