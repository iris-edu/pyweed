...
class Ui_PreferencesDialog(object):
    def setupUi(self, PreferencesDialog):
        ...
        PreferencesDialog.resize(352, 383)
        ...
        self.outputGroupBox = QtWidgets.QGroupBox(PreferencesDialog)
        self.outputGroupBox.setObjectName("outputGroupBox")
        self.formLayout_5 = QtWidgets.QFormLayout(self.outputGroupBox)
        self.formLayout_5.setObjectName("formLayout_5")
        self.label_4 = QtWidgets.QLabel(self.outputGroupBox)
        self.label_4.setObjectName("label_4")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.LabelRole, self.label_4)
        self.waveformSaveFormatComboBox = QtWidgets.QComboBox(self.outputGroupBox)
        self.waveformSaveFormatComboBox.setObjectName("waveformSaveFormatComboBox")
        self.formLayout_5.setWidget(0, QtWidgets.QFormLayout.FieldRole, self.waveformSaveFormatComboBox)
        self.waveformUseEventTimeCheckBox = QtWidgets.QCheckBox(self.outputGroupBox)
        self.waveformUseEventTimeCheckBox.setWhatsThis("")
        self.waveformUseEventTimeCheckBox.setObjectName("waveformUseEventTimeCheckBox")
        self.formLayout_5.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.waveformUseEventTimeCheckBox)
        ...
        self.formLayout_3.setWidget(1, QtWidgets.QFormLayout.FieldRole, self.cacheSizeSpinBox)
    ...
    def retranslateUi(self, PreferencesDialog):
        ...
        self.outputGroupBox.setTitle(_translate("PreferencesDialog", "Output Options"))
        self.label_4.setText(_translate("PreferencesDialog", "Format"))
        self.waveformUseEventTimeCheckBox.setToolTip(_translate("PreferencesDialog", "For SAC output, use the event time as the origin (iztype=\"io\")"))
        self.waveformUseEventTimeCheckBox.setText(_translate("PreferencesDialog", "Use event time"))
        self.groupBox.setToolTip(_translate("PreferencesDialog", "Local storage for downloaded data files"))
