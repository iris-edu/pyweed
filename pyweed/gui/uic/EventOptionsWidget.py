...
class Ui_EventOptionsWidget(object):
    def setupUi(self, EventOptionsWidget):
        ...
        EventOptionsWidget.resize(302, 671)
        ...
        self.horizontalLayout_3.addWidget(self.timeFromStationsToolButton)
        ...
        spacerItem13 = QtGui.QSpacerItem(QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        ...
        self.horizontalLayout_6.addWidget(self.locationFromStationsToolButton)
