...
class Ui_EventOptionsWidget(object):
    def setupUi(self, EventOptionsWidget):
        ...
        EventOptionsWidget.resize(305, 698)
        ...
        self.locationRangeLayout.addItem(spacerItem8)
        ...
        self.verticalLayout_6.addWidget(self.locationDistanceFromPointRadioButton)
        ...
        self.locationDistanceFromPointLayout.addItem(spacerItem9)
        ...
        self.verticalLayout_6.addWidget(self.locationDistanceFromEventsRadioButton)
        self.locationDistanceFromEventsLayout = QtGui.QHBoxLayout()
        self.locationDistanceFromEventsLayout.setContentsMargins(24, -1, -1, -1)
        self.locationDistanceFromEventsLayout.setSpacing(0)
        self.locationDistanceFromEventsLayout.setObjectName(_fromUtf8("locationDistanceFromEventsLayout"))
        self.horizontalLayout_19 = QtGui.QHBoxLayout()
        self.horizontalLayout_19.setSizeConstraint(QtGui.QLayout.SetDefaultConstraint)
        self.horizontalLayout_19.setContentsMargins(0, -1, -1, -1)
        self.horizontalLayout_19.setSpacing(4)
        self.horizontalLayout_19.setObjectName(_fromUtf8("horizontalLayout_19"))
        self.distanceFromStationsMinRadiusDoubleSpinBox = QtGui.QDoubleSpinBox(self.locationGroupBox)
        self.distanceFromStationsMinRadiusDoubleSpinBox.setMinimum(0.0)
        self.distanceFromStationsMinRadiusDoubleSpinBox.setMaximum(180.0)
        self.distanceFromStationsMinRadiusDoubleSpinBox.setObjectName(_fromUtf8("distanceFromStationsMinRadiusDoubleSpinBox"))
        self.horizontalLayout_19.addWidget(self.distanceFromStationsMinRadiusDoubleSpinBox)
        self.label_5 = QtGui.QLabel(self.locationGroupBox)
        self.label_5.setObjectName(_fromUtf8("label_5"))
        self.horizontalLayout_19.addWidget(self.label_5)
        self.distanceFromStationsMaxRadiusDoubleSpinBox = QtGui.QDoubleSpinBox(self.locationGroupBox)
        self.distanceFromStationsMaxRadiusDoubleSpinBox.setMinimum(0.0)
        self.distanceFromStationsMaxRadiusDoubleSpinBox.setMaximum(180.0)
        self.distanceFromStationsMaxRadiusDoubleSpinBox.setObjectName(_fromUtf8("distanceFromStationsMaxRadiusDoubleSpinBox"))
        self.horizontalLayout_19.addWidget(self.distanceFromStationsMaxRadiusDoubleSpinBox)
        self.label_10 = QtGui.QLabel(self.locationGroupBox)
        self.label_10.setEnabled(True)
        self.label_10.setAlignment(QtCore.Qt.AlignCenter)
        self.label_10.setObjectName(_fromUtf8("label_10"))
        self.horizontalLayout_19.addWidget(self.label_10)
        self.locationDistanceFromEventsLayout.addLayout(self.horizontalLayout_19)
        spacerItem10 = QtGui.QSpacerItem(0, 0, QtGui.QSizePolicy.Expanding, QtGui.QSizePolicy.Minimum)
        self.locationDistanceFromEventsLayout.addItem(spacerItem10)
        self.locationDistanceFromEventsLayout.setStretch(1, 1)
        self.verticalLayout_6.addLayout(self.locationDistanceFromEventsLayout)
    ...
    def retranslateUi(self, EventOptionsWidget):
        ...
        self.locationDistanceFromEventsRadioButton.setText(_translate("EventOptionsWidget", "Distance from selected stations", None))
        self.label_5.setText(_translate("EventOptionsWidget", "-", None))
        self.label_10.setText(_translate("EventOptionsWidget", "degrees", None))
