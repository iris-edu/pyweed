...
class Ui_StationOptionsWidget(object):
    def setupUi(self, StationOptionsWidget):
        ...
        StationOptionsWidget.resize(305, 699)
        ...
        self.horizontalLayout_7.setContentsMargins(24, -1, -1, -1)
        ...
        StationOptionsWidget.setTabOrder(self.timeFromEventsRadioButton, self.locationRangeRadioButton)
        StationOptionsWidget.setTabOrder(self.locationRangeRadioButton, self.locationDistanceFromPointRadioButton)
        StationOptionsWidget.setTabOrder(self.locationDistanceFromPointRadioButton, self.locationFromEventsRadioButton)
