...
class Ui_StationOptionsWidget(object):
    def setupUi(self, StationOptionsWidget):
        ...
        StationOptionsWidget.resize(307, 671)
...
"}"))
        ...
        StationOptionsWidget.setTabOrder(self.locationRangeRadioButton, self.locationRangeNorthLineEdit)
        StationOptionsWidget.setTabOrder(self.locationRangeNorthLineEdit, self.locationRangeEastLineEdit)
        StationOptionsWidget.setTabOrder(self.locationRangeEastLineEdit, self.locationRangeWestLineEdit)
        StationOptionsWidget.setTabOrder(self.locationRangeWestLineEdit, self.locationRangeSouthLineEdit)
        StationOptionsWidget.setTabOrder(self.locationRangeSouthLineEdit, self.locationDistanceFromPointRadioButton)
        StationOptionsWidget.setTabOrder(self.locationDistanceFromPointRadioButton, self.distanceFromPointMinRadiusLineEdit)
        StationOptionsWidget.setTabOrder(self.distanceFromPointMinRadiusLineEdit, self.distanceFromPointMaxRadiusLineEdit)
        StationOptionsWidget.setTabOrder(self.distanceFromPointMaxRadiusLineEdit, self.distanceFromPointEastLineEdit)
        StationOptionsWidget.setTabOrder(self.distanceFromPointEastLineEdit, self.distanceFromPointNorthLineEdit)
        StationOptionsWidget.setTabOrder(self.distanceFromPointNorthLineEdit, self.locationDistanceFromEventsRadioButton)
        StationOptionsWidget.setTabOrder(self.locationDistanceFromEventsRadioButton, self.distanceFromEventsMinradiusLineEdit)
        StationOptionsWidget.setTabOrder(self.distanceFromEventsMinradiusLineEdit, self.distanceFromEventsMaxradiusLineEdit)
    ...
    def retranslateUi(self, StationOptionsWidget):
        ...
        self.label.setText(_translate("StationOptionsWidget", "between", None))
        self.label_11.setText(_translate("StationOptionsWidget", "degrees", None))
        self.label_2.setText(_translate("StationOptionsWidget", "and", None))
        self.label_10.setText(_translate("StationOptionsWidget", "degrees", None))
        self.label_6.setText(_translate("StationOptionsWidget", "from", None))
        self.label_4.setText(_translate("StationOptionsWidget", "E", None))
        self.label_8.setText(_translate("StationOptionsWidget", "and", None))
