...
class Ui_EventQueryDialog(object):
    ...
    def retranslateUi(self, EventQueryDialog):
        ...
        self.locatoinDrawOnMapPushButton_1.setText(_translate("EventQueryDialog", "Draw on map", None))
        self.locationDostanceFromPointRadioButton.setText(_translate("EventQueryDialog", "Distance from point", None))
        ...
        self.locationDrawOnMapPushButton_2.setText(_translate("EventQueryDialog", "Draw on map", None))
        self.label_6.setText(_translate("EventQueryDialog", "from", None))
        self.distanceFromEventsRradioButton.setText(_translate("EventQueryDialog", "Distance from selected events", None))
