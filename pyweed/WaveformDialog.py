...
class Ui_WaveformDialog(object):
    ...
    def retranslateUi(self, WaveformDialog):
        ...
        self.saveGroupBox.setTitle(_translate("WaveformDialog", "Save / Reformat Waveforms", None))
        ...
        self.savePushButton.setText(_translate("WaveformDialog", "Save Downloaded Waveforms", None))
