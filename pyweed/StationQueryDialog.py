...
class Ui_StationQueryDialog(object):
    def setupUi(self, StationQueryDialog):
        ...
        StationQueryDialog.resize(339, 767)
        sizePolicy = QtGui.QSizePolicy(QtGui.QSizePolicy.Preferred, QtGui.QSizePolicy.Preferred)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(StationQueryDialog.sizePolicy().hasHeightForWidth())
        StationQueryDialog.setSizePolicy(sizePolicy)
        StationQueryDialog.setStyleSheet(_fromUtf8("QGroupBox {\n"
...
""))
        ...
        self.locationRangeLayout.addItem(spacerItem4)
