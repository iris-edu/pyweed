...
""))
        ...
        self.horizontalLayout_3.addWidget(self.endtimeLabel)
        ...
        self.locationRangeLayout.addItem(spacerItem5)
        ...
        self.horizontalLayout_11.addWidget(self.distanceFromEventsMaxradiusLineEdit)
