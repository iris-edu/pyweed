...
class Ui_StationOptionsDialog(object):
    def setupUi(self, StationOptionsDialog):
        ...
        self.gridLayout_3.addWidget(self.locationRangeWestLineEdit, 2, 0, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.locationRangeEastLineEdit, 2, 2, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.locationRangeSouthLineEdit, 3, 1, 1, 1)
        ...
        self.gridLayout_3.addWidget(self.locationRangeNorthLineEdit, 0, 1, 1, 1)
